...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.set_defaults(
        ...
        stationary_fast_terminal_duration_s=8.0,
        stationary_fast_terminal_segments=12,
        stationary_fast_terminal_rollout_steps=8,
        stationary_fast_terminal_target_ms=800.0,
        stationary_fast_terminal_max_ms=1500.0,

...
FAST_G1_CONFLICT_TIME = 0.55
FAST_G1_ENDPOINT_MARGIN = 0.12
FAST_G1_MIN_ACTIVE_A_NORM = 0.02
FAST_G1_REFERENCE_DENSE_MIN_RANGE = (0.04, 0.08)
FAST_G1_NEAR_DENSE_MIN_RANGE = (0.07, 0.08)
FAST_G1_BANDS = {
    "near": (0.070, 0.080),
    "easy": (0.075, 0.080),
    "main": (0.065, 0.075),
...
FAST_V3_ACTIVE_CONSTRAINTS = 8
FAST_V3_TRUST_REGION = 0.030
FAST_V3_RELAXATION = 0.85
FAST_V3_SENSITIVITY_EPS = 1.0e-5
FAST_V3_MIN_IMPROVEMENT = 1.0e-4
FAST_V3_SLACK_WEIGHT = 1.0e5
FAST_V3_CLEARANCE_GAIN = 5.0
FAST_V4_MAX_ITERATIONS = 1
FAST_V4_TARGET_CLEARANCE = 0.095
FAST_V4_CLEARANCE_REWARD = 0.0
FAST_V4_ACCEPTANCE_SCALES = (0.85, 0.65, 0.45, 0.30, 0.20, 0.10)
FAST_V4_PROJECTION_SWEEPS = 8
FAST_V4_DRIVE_SCALE = 0.75
